...
#include "training_interfaces/srv/detail/value__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = training_interfaces::srv::Value_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const training_interfaces::srv::Value_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<training_interfaces::srv::Value_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Value_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const training_interfaces::srv::Value_Request *>(
...
static size_t _Value_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Value_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Value_Request__callbacks = {
...
static rosidl_message_type_support_t _Value_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Value_Request__callbacks,
...
{
  return &training_interfaces::srv::typesupport_fastrtps_cpp::_Value_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = training_interfaces::srv::Value_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const training_interfaces::srv::Value_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<training_interfaces::srv::Value_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Value_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const training_interfaces::srv::Value_Response *>(
...
static size_t _Value_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Value_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Value_Response__callbacks = {
  "training_interfaces::srv",
  "Value_Response",
...
static rosidl_message_type_support_t _Value_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Value_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &training_interfaces::srv::typesupport_fastrtps_cpp::_Value_Response__handle;
}
...
static service_type_support_callbacks_t _Value__callbacks = {
  "training_interfaces::srv",
  "Value",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, training_interfaces, srv, Value_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, training_interfaces, srv, Value_Response)(),
...
static rosidl_service_type_support_t _Value__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Value__callbacks,
...
{
  return &training_interfaces::srv::typesupport_fastrtps_cpp::_Value__handle;
}
